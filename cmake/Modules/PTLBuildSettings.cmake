...
if(NOT CMAKE_BUILD_TYPE AND NOT CMAKE_CONFIGURATION_TYPES)
    message(STATUS "Forcing PTL CMAKE_BUILD_TYPE to '${__ptl_default_build_type}' as none was specified")
    set(CMAKE_BUILD_TYPE "${__ptl_default_build_type}" CACHE STRING "Choose the type of build." FORCE)
...
# Otherwise we leave this at the discretion of the parent project
#
...
if((NOT BUILD_SHARED_LIBS) AND (NOT BUILD_STATIC_LIBS))
    message(FATAL_ERROR "Neither BUILD_STATIC_LIBS nor BUILD_SHARED_LIBS are set. One must be ON")
endif()
...
# Add allocation export symbol for the PTL module
# Should this be a target_compile_definition?
...
#
################################################################################
# Coverage compile/link settings
# See also: https://discourse.cmake.org/t/best-practice-for-multi-config-build-options/2049
...
if(PTL_USE_COVERAGE)
    if((NOT CMAKE_BUILD_TYPE STREQUAL "Debug") AND (NOT CMAKE_CONFIGURATION_TYPES))
        message(WARNING "PTL_USE_COVERAGE is ON, but the build mode is not 'Debug': coverage testing will be disabled.")
        set(PTL_USE_COVERAGE OFF CACHE BOOL "Enable code coverage (disabled)" FORCE)
    else()
        include(PTLCoverage)
    endif()
endif()
