...
#------------------------------------------------------------------------------#
# function ptl_message_on_change(<VAR> <MESSAGE>)
# Watch <VAR> and print <MESSAGE> and <VAR>'s value when the value changes
#
function(ptl_message_on_change _var _prefix)
    ...
    set(${_ptl_watch_var_name} "${${_var}}" CACHE INTERNAL "Last value of ${_var}" FORCE)
    message(STATUS "${_prefix} - ${${_var}}")
endfunction()


#------------------------------------------------------------------------------#
# function ptl_add_feature(<NAME> <DOCSTRING>)
#          Store activation of a feature and a docstring describing it.
#          <NAME> should be a variable whose value indicates activation of the feature
#
...
#------------------------------------------------------------------------------#
# function ptl_add_option(<OPTION_NAME> <DOCSTRING> <DEFAULT_SETTING>)
# Add an option for master project only, always reporting its value
#
...
# Encapsulates common build/install for main PTL shared/static libs
#
function(ptl_build_library)
    cmake_parse_arguments(LIB
    "" "TYPE;TARGET_NAME;OUTPUT_NAME" "SOURCES;EXTRA_ARGS"
    ${ARGN})
