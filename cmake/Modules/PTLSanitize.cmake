if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|(Apple)?Clang")
    ...
    if(NOT ("${PTL_SANITIZER_TYPE}" STREQUAL "thread"))
        string(APPEND ptl_sanitize_args " -fno-optimize-sibling-calls -fno-omit-frame-pointer -fno-inline-functions")
    endif()
else()
    set(ptl_sanitize_args)
    message(WARNING "PTL_USE_SANITIZER is ON, but is not supported for compiler '${CMAKE_CXX_COMPILER_ID}")
endif()
...
string(APPEND CMAKE_MODULE_LSaKER_FLAGS " ${ptl_sanitize_args}")
